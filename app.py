...
try:
    ...
    with tab1:
        ...
        if not single_day:
            ...
            commission_fig.update_layout(xaxis=dict(fixedrange=True, title=None), yaxis=(dict(tickprefix='$', fixedrange=True, title=None, rangemode='tozero')), dragmode=False)
            ...
            views_fig.update_layout(xaxis=dict(fixedrange=True, title=None), yaxis=(dict(fixedrange=True, title=None, rangemode='tozero')), dragmode=False)
    ...
    with tab3:
        ...
        with st.popover('Goal options', wrap=True):
            ...
            selected_analytic = st.selectbox('Metric', analytics)
